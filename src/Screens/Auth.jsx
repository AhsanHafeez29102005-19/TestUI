    ...
    <SafeAreaView style={styles.container}>
      <View style={styles.top}>
        ...
        <View style={styles.toggleContainer}>
          <TouchableOpacity
            style={[styles.toggleBtn, isLogin ? styles.activeBtn : styles.inactiveBtn]}
      ...
      <View style={styles.bottom}>
        {isLogin ? (
          <>
            ...
            <Text style={styles.subText}>Make sure that you already have an account</Text>
            <View style={styles.inputWrapper}>
              <Image style={{ height: 24, width: 24 }} source={require('../images/email.png')} />
              <TextInput placeholder="Email" style={styles.input} />
            </View>
            <View style={styles.inputWrapper}>
              <Image style={{ height: 24, width: 24 }} source={require('../images/lock.png')} />
              <TextInput placeholder="Password" secureTextEntry style={styles.input} />
              <Image style={{ height: 24, width: 24 }} source={require('../images/view.png')} />
            </View>
            ...
            <TouchableOpacity onPress={() => navigation.navigate('Verify')} style={styles.actionBtn}>
          ...
          <>
            ...
            <View style={styles.inputWrapper}>
              <Image style={{ height: 24, width: 24 }} source={require('../images/user.png')} />
